...
def button_click(number):
	current = e.get()
	e.delete(0, END)
	e.insert(10, str(current) + str(number))
...
button_cos= Button(root,text='cos',padx=40,pady=20, command=cosine)
button_sin= Button(root,text='sin',padx=40,pady=20, command=sine)
button_tan= Button(root,text='tan',padx=40,pady=20, command=tangent)
...
button_multiply = Button(root, text="x", padx=50, pady=20, command=button_multiply)
